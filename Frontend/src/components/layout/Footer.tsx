...
const Footer = () => {
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10" id="contacto">
        <nav>
          <h6 className="footer-title">Tienda</h6>
          <a className="link link-hover" href="/">
            Productos Gamer
          </a>
          <a className="link link-hover" href="/creararticulo">
            Registrar Producto
          </a>
        </nav>
      </footer>

      <footer className="footer bg-base-300 text-base-content border-base-100 border-t px-10 py-4">
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                <path
                  d="M19.615 3.184
                c-3.604-.246-11.631-.245-15.23 0
